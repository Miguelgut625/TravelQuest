...
export function getProfileScreenStyles(colors, isDarkMode, width) {
  return StyleSheet.create({
    container: {
      flex: 1,
      backgroundColor: isDarkMode ? colors.background : colors.background,
    ...
    headerBackground: {
      backgroundColor: isDarkMode ? colors.surface : colors.text?.light || '#A8DADC',
      paddingTop: 20,
      paddingBottom: 40,
    ...
    avatarContainer: {
      ...
      elevation: 10,
      borderWidth: 3,
      borderColor: isDarkMode ? colors.accent : colors.text?.light || '#A8DADC',
    },
    avatar: {
      width: 100,
      height: 100,
      borderRadius: 50,
      backgroundColor: isDarkMode ? colors.accent : colors.background,
      justifyContent: 'center',
      alignItems: 'center',
      overflow: 'hidden',
    },
    cameraIconContainer: {
      ...
      right: 0,
      bottom: 0,
      backgroundColor: isDarkMode ? colors.accent : '#274472',
      width: 32,
      height: 32,
      borderRadius: 16,
      justifyContent: 'center',
      alignItems: 'center',
      borderWidth: 2,
      borderColor: isDarkMode ? colors.background : colors.text?.light || '#A8DADC',
      shadowColor: '#000',
      shadowOffset: { width: 0, height: 2 },
      shadowOpacity: 0.2,
      shadowRadius: 4,
    ...
    avatarText: {
      fontSize: 48,
      fontWeight: 'bold',
      color: isDarkMode ? colors.background : colors.text?.primary || '#1D3557',
    },
    userInfo: {
      flex: 1,
      padding: 10,
    ...
    name: {
      fontSize: 28,
      fontWeight: 'bold',
      color: isDarkMode ? colors.text.primary : colors.text?.primary || '#1D3557',
      marginBottom: 5,
    },
    email: {
      fontSize: 16,
    ...
    customTitle: {
      fontSize: 20,
      fontWeight: 'bold',
      color: isDarkMode ? colors.accent : '#669BBC',
      marginBottom: 5,
      textAlign: 'center',
      letterSpacing: 1,
    },
    levelContainer: {
      marginTop: 10,
      backgroundColor: isDarkMode ? colors.surface : '#274472',
      padding: 10,
      borderRadius: 15,
    },
    levelText: {
      color: isDarkMode ? colors.text.primary : '#EDF6F9',
      fontWeight: 'bold',
      fontSize: 16,
      marginBottom: 5,
    },
    progressBar: {
      height: 8,
      backgroundColor: isDarkMode ? colors.border : '#1B263B',
      borderRadius: 4,
      marginVertical: 5,
      width: '100%',
      overflow: 'hidden',
    ...
    progress: {
      height: 8,
      backgroundColor: isDarkMode ? colors.accent : '#41729F',
      borderRadius: 4,
    },
    xpText: {
      color: isDarkMode ? colors.text.secondary : '#A9D6E5',
      fontSize: 12,
      textAlign: 'right',
    },
    stats: {
      flexDirection: 'row',
      justifyContent: 'space-around',
      backgroundColor: isDarkMode ? '#374151' : colors.text?.primary || '#1D3557',
      marginTop: -30,
      marginHorizontal: 20,
      borderRadius: 20,
      shadowColor: '#000',
    ...
    statValue: {
      fontSize: 28,
      fontWeight: 'bold',
      color: isDarkMode ? colors.accent : '#EDF6F9',
      marginBottom: 5,
    },
    statLabel: {
      fontSize: 14,
      color: isDarkMode ? colors.text.secondary : colors.text?.light || '#A8DADC',
    ...
    socialButtonText: {
      color: isDarkMode ? colors.background : '#EDF6F9',
      fontSize: 16,
      fontWeight: 'bold',
      flex: 1,
      marginLeft: 10,
    ...
    privacyRadio: {
      ...
      alignItems: 'center',
      borderWidth: 1,
      borderColor: isDarkMode ? colors.accent : colors.secondary,
      borderRadius: 20,
      paddingVertical: 8,
      paddingHorizontal: 14,
      marginHorizontal: 2,
      backgroundColor: isDarkMode ? colors.background : colors.white || '#FFFFFF',
      minWidth: 90,
      flexGrow: 1,
      marginVertical: 4,
      flexBasis: '30%',
    ...
    privacyRadioText: {
      marginLeft: 6,
      color: isDarkMode ? colors.text.primary : colors.secondary,
      fontWeight: 'bold',
    },
    ...
    topCityBarContainer: {
      height: 8,
      backgroundColor: isDarkMode ? colors.border : '#E0E0E0',
      borderRadius: 4,
      marginBottom: 4,
      overflow: 'hidden',
    },
    ...
    saveButton: {
      backgroundColor: isDarkMode ? colors.accent : '#669BBC',
    },
    modalButtonText: {
      color: '#EDF6F9',
      fontSize: 16,
