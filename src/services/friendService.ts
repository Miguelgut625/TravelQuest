...
export const sendFriendRequest = async (senderId: string, receiverId: string) => {
  try {
    ...
    return { 
      success: false, 
      error: error.response?.data?.error || 'Error al enviar la solicitud de amistad' 
    };
  }
};
...
export const acceptFriendRequest = async (requestId: string) => {
  try {
    ...
    return { 
      success: false, 
      error: error.response?.data?.error || 'Error al aceptar la solicitud de amistad' 
    };
  }
};
...
export const rejectFriendRequest = async (requestId: string) => {
  try {
    ...
    return { 
      success: false, 
      error: error.response?.data?.error || 'Error al rechazar la solicitud de amistad' 
    };
  }
};
...
export const deleteFriendship = async (userId1: string, userId2: string) => {
  try {
    ...
    return { 
      success: false, 
      error: error.response?.data?.error || 'Error al eliminar la amistad' 
    };
  }
};
...
export const cancelFriendRequest = async (senderId: string, receiverId: string) => {
  try {
    ...
    return { 
      success: false, 
      error: error.response?.data?.error || 'Error al cancelar la solicitud de amistad' 
    };
  }
};
